'use strict';
const div_ProductoBuscado = document.getElementById('div_ProductoBuscado');
console.log(div_ProductoBuscado);

console.log("hola desde productos deseado");
...
const parseProductoBuscado =JSON.parse(productoBuscado);


const createCard = ( object ) => {
   
    const div_Productos = document.getElementById('div_ProductoBuscado');
    console.log("object desde create card",object);

        let innerDivProductos = "";
        const element = object[0];
        innerDivProductos+=`<div class="container-fluid  ps-lg-5 " >
  ...
  createCard(parseProductoBuscado);
